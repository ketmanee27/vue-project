...
<head>
	...
	<title>ประวัติเข้าทำข้อสอบ</title>
...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">ประวัติเข้าทำข้อสอบ</div>
		<br>
		<div class="col-md-4 offset-md-4 mb-4">
			<select class="form-control select2" onchange="location.replace('history.php?quiz_id='+this.value)">
				<option value="all" <?php echo isset($_GET['quiz_id']) && $_GET['quiz_id'] == 'all' ? 'selected' : '' ?>>บทเรียนทั้งหมด</option>
				<?php 
				$where =''; 
			...
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td data-label="นักศึกษา"><?php echo ucwords($row['student']) ?></td>
						<td data-label="บทเรียน"><?php echo $row['title'] ?></td>
						<td data-label="คะแนน"><?php echo $row['score'].'/'.$row['total_score']  ?> คะแนน</td>
					</tr>
					<?php
					}
					}
