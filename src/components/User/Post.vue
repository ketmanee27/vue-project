    ...
    >
      ...
      <v-card-title>
        {{ postuser.user_firstname }} {{ postuser.user_lastname }}&nbsp;<span
          style="color: #21777f" >{{ postuser.post_detail }}</span
        >
      </v-card-title>
            ...
            <v-form v-model="valid2" ref="form2">
              ...
              >
                <div v-if="comment.post_id === postuser.post_id">
                  ...
                  <div color="#099fae" class="mb-5" style="font-size:1.1em;  font-weight:bold">
                  ...
                  <div>&nbsp;<span
          style="color: #21777f; font-size: 1.1em; margin-top:30px;">{{ comment.comment_detail }}</span></div>
